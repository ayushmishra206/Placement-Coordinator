...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="../Profilers/PriProfile/index.php">Administrator Login</a>
                        </li>
                    </ul>
        ...
        <header style="background-color:#363636;">
            <div class="header-content" >
                <div style="color: white;">
                    <h1>PLACEMENT COORDINATOR</h1>
                    <br>
                    <!-- <hr style="background-color: #16a085;"> -->
                    <p>We are here to Build your Skills and Career with our Driven Passion and Reality.</br>Click Below to Get Our Current Drive
                        Details</p>
                    <a href="CompanyDetails.php" class="btn btn-primary btn-xl page-scroll" style="background-color: #16a085;">Current Drives</a>
                    <a href="../iprep/index.html" class="btn btn-primary btn-xl page-scroll"style="background-color: #16a085;">Interview Preparation</a>
                </div>
            </div>
        </header>
        <div class="footer">
