	...
	<body>
		...
		<div class="templatemo-flex-row">
			...
			<div class="templatemo-content col-1 light-gray-bg">
					...
					<div class="row">
						<nav class="templatemo-top-nav col-lg-12 col-md-12">
							<ul class="text-uppercase">
								...
								<li>
									<a href="CompanyDetails">Drives</a>
								</li>
								<li>
						...
						<form action="pref.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
							<div class="row form-group">
								...
								<div class="col-lg-6 col-md-6 form-group">
									...
									<input type="text"  name="Lname" class="form-control" id="inputLastName" placeholder="Kumar">
								</div>
				
				<div class="col-lg-6 col-md-6 form-group">
									<label for="usn">Registration Number</label>
									<input type="text" name="USN" class="form-control" id="usn" placeholder="17101XXXX" >
								</div>
				...
				<div class="col-lg-6 col-md-6 form-group">
									<label for="BE">Current Aggregate</label>
