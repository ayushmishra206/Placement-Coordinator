        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <p>Being The Head of the Department, using this portal you can approve the details of students in Manage Students tab. You may Revoke the Details and Approve them if it is Wrong or Entered Correctly Respectively.</p> 
              ...
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Get the Latest Upcoming Events in Our Campus</p>  
                  </div>
                </div>                
              </div>            
            </div>
