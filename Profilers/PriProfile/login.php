        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to Placement Coordinator</h2><hr>
              <p>This is the administrator dashboard. The primary goal of this is to view Student details, Check their Eligibility Criteria and to look at the details of placement drives</p>    
              ...
              <div class="templatemo-content-widget orange-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Get the Latest Update about Placements at Manipal
...
$RESULT=mysqli_query($connect, "SELECT DISTINCT count(CompanyName) from addpdrive where PVenue LIKE '%MUJ%' AND YEAR(Date)=YEAR(NOW())");
