...
<html lang="en">
 ...
 <center><h2>Approved Students List of BCOM</h2></center>
			...
			<table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>            
                    ...
                    <td><a  class="white-text templatemo-sort-by">Registration Number </a></td>
...
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='BCOM' LIMIT $start_from, $num_rec_per_page"; 
...
$connect= mysqli_connect('localhost','root','');
mysqli_select_db($connect, 'details');
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='BCOM'"; 
$rs_result = mysqli_query($connect, $sql); //run the query
