...
<html lang="en">
 ...
 <center><h2>Approved Students List of BA</h2></center>
...
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='BA' LIMIT $start_from, $num_rec_per_page"; 
...
$connect= mysqli_connect('localhost','root','');
mysqli_select_db($connect, 'details');
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='BA'"; 
$rs_result = mysqli_query($connect, $sql); //run the query
