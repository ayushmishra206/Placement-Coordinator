      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
         <ul>
            ...
            <li><a href=""><i class="fa fa-home fa-fw"></i>Placement Drives</a></li>           
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <p>Department Notifications to HOD</p>
            <form action="post.php" method ="POST" enctype="multipart/form-data">
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    <label class="control-label" for="inputNote">Subject:</label>
                    <input type="text" class="form-control" placeholder="Subject" name="subject" rows="2">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    <label class="control-label" for="inputNote">Message:</label>
                    <input type="text" class="form-control" placeholder="Message" name="message" rows="2">
                </div>
              </div>
